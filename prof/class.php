...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <section class="main">
                <div class="main-top">
                    <h1 style="margin-left: 43%">Class Record</h1>
                ...
                <div class="tbcontainer" id="tbcontainer">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT DISTINCT students.stud_id, stud_fname, stud_mname, stud_lname, stud_class.stud_prog, stud_class.stud_course, stud_class.stud_sec, yandsec.year
                            FROM students 
                            ...
                            <tr>
                                <td><?= $row['stud_id']; ?></td>
                                <td><?= $row['stud_fname'], $space, $row['stud_mname'], $space, $row['stud_lname']; ?></td>
                                <td><?= $row['stud_prog']; ?> </td>
                                <td><?= $row['year']; ?></td>
