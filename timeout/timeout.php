...
<html lang="en">
    <head>
        ...
        <script src="../prof/ht.js"></script>
        <script type="text/javascript" src= "../prof/attendance.js">
        </script>
        <title>Attendance</title> 
        <link rel="stylesheet" type="text/css" href="../prof/attendance.css">
    ...
    <body>
        <div class="container">
            <nav>
                <ul>
                    <br>
                    <li><a href="../prof/dashboard.php" class="logo">
                    ...
                    <li><a href="" style="cursor:auto;"><i class="fas fa-user-tie"></i>
                        <span class="nav-item">Professor</span>
                    </a></li> 
                    <hr style="border: 1px solid blue;">
                    <br>
                    <li><a href="../prof/dashboard.php"><i class="fas fa-house-user"></i>
                        <span class="nav-item">Home</span>
                    </a></li>
                    <a href=" ../prof/class.php"><i class="fas fa-book"></i>
                        <span class="nav-item">Class</span>
                    </a></li>
                    <a href="../prof/entry-point.php"><i class="fas fa-right-to-bracket"></i>
                        <span class="nav-item">Entry Point</span>
                    </a></li>
                    <li><a href="../prof/attendance.php"><i class="fas fa-id-card"></i>
                        <span class="nav-item">Attendance</span>
                    </a></li>
                    <li><a href="../prof/report.php">
                        <i class="fas fa-database"></i>
                        <span class="nav-item">Report</span>
                      </a></li>
                    <li><a href="../prof/dashboard.php?logout=''" class="logout"><i class="fas fa-sign-out-alt"></i>
            ...
            <section class="main">
            <h1 style="margin-left:38%;">Class Attendance - Time Out</h1>
                <div class="main-top">
                <form method="post" id="" class="input-group" action="#">
                    ...
                    <a style="" href="../prof/attendance.php"> <i style="margin-right: 50px" class="fas fa-square-check"> TIME IN</i></a>
                </div>
                <br>
            ...
            <script type="text/javascript">
                ...
                var ccs = sessionStorage.getItem("value"); // dito oki 
                    ...
                    function showHint(str) {
                        ...
                        xmlhttp.open("GET", "gethintout.php?id2=" + str + "&course=" + ccs, true); // tapos sinama ko siya sa parameter. ahhhh hahahahha nyemass ng naencounter ko pa lang is yung document.eneme hahahahaha okay lang yan. congrats. meron a baproblem?
                        xmlhttp.send();
                        }
                    }
